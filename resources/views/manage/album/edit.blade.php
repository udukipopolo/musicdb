        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        {{ Form::text('title', $album->title, ['class'=>'form-control'.ViewUtil::hasErrorClass($errors, 'title')]) }}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-4">
                        {{ Form::select('artist_id', [''=>'新規登録']+$artists->toArray(), $album->arist_id, ['class'=>'form-control js-select2'.ViewUtil::hasErrorClass($errors, 'artist_id'), 'id'=>'album_artist']) }}
                        @include('layouts.parts.error_message', ['key'=>'artist_id'])
                    </div>
                    <div class="col-md-4">
                        {{ Form::text('artist_name', $album->artist_name, ['class'=>'form-control'.ViewUtil::hasErrorClass($errors, 'artist_name'), 'id'=>'album_artist_name']) }}
                        ...
                        <table class="table">
                            ...
                            <tbody id="track_list">
                                ...
                                <tr>
                                    <td>{{ $no }}</td>
                                    <td>
                                        {{ Form::text("musics[{$no}]", old('musics.'.$no) ?: ($music = $musics->firstWhere('track_no', $no)) ? $music->title : null, ['class'=>'form-control']) }}
                                    </td>
                                </tr>
                                @endfor
                            </tbody>
